...
const TitleCards = ({ title, category }) => {
  ...
  useEffect(() => {
    ...
    currentRef.addEventListener('wheel', handleWheel, { passive: false }); // Add event listener with passive: false

    return () => {
      currentRef.removeEventListener('wheel', handleWheel); // Remove event listener on component unmount
    };
  }, []);
